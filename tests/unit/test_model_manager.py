...
class TestSetupGenerationKwargs:
    ...
    def test_setup_generation_kwargs_qwen_stop_strings(
        self, template_manager_initialized
    ):
    ...
    def test_setup_generation_kwargs_non_qwen_no_stop_strings(
        self, template_manager_initialized
    ):
    ...
    def test_setup_generation_kwargs_devstral_stop_strings(
        self, template_manager_initialized
    ):
    ...
    def test_setup_generation_kwargs_stop_param_override(
        self, template_manager_initialized
    ):
...
class TestGenerateResponseIntegration:
    ...
    def test_generate_response_with_tools_success(
        self, mock_get_parser, mock_generate, mock_format, mock_load_model
    ):
        ...
        mock_parser.parse_tool_calls.return_value = ("parsed content", [])
    ...
    def test_generate_response_stream_success(
        self, mock_format, mock_stream, mock_load_model
    ):
