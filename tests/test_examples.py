...
from mlx_server_nano.model_manager import load_model, generate_response_with_tools
from mlx_server_nano.tool_calling import get_tool_parser
...
class TestExampleUnitTests:
    ...
    def test_tool_parser_selection_example(self):
        """Example: Test tool parser selection logic."""
        ...
        for model_name, expected_type in test_cases:
            ...
            assert expected_type in str(type(parser))
...
class TestExampleIntegrationTests:
    ...
    def test_complete_generation_flow_example(
        ...
        mock_parser.parse_tool_calls.return_value = ("Hello! How can I help you?", [])
...
def test_example_parametrized(
    model_name, expected_stop_strings, template_manager_initialized
):
